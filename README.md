...
A simple **Spring Boot REST API** for managing products with basic CRUD operations.  
This project demonstrates clean layered architecture using **Controller, Service, and Repository**.
